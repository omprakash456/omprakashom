...
public class RegisterStepDefinition {
	RegisterPageActions RegAct = new RegisterPageActions();
	...
	@When("User enters Gender,Firstname,Lastname,E-Mail,Password and CPassword")
	...
	public void user_get_successfully_registerd_message_and_log_out() {
	   ...
	   HelperClass.log.info("Login succesful");
	   RegAct.clickLogout();
	}
}
